**Welcome to your Hacknet Extender project**

**About**

Hacknet Extensions GUI is a local-first React app for managing Hacknet extension data (nodes, missions, factions, scripts, actions, links, and people) using an embedded SQLite store in the browser (`sql.js`).
